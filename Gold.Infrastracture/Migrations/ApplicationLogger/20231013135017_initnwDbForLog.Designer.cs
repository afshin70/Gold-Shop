...
{
    [DbContext(typeof(ApplicationLoggerContext))]
    [Migration("20231013135017_initnwDbForLog")]
    partial class initnwDbForLog
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gold.Domain.Entities.AuthEntities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsLocked = false,
                            Mobile = "",
                            PasswordHash = "I8HMkxPuoMlA/opIA++uOQ==",
                            PasswordSalt = "fe890d17-26f6-4767-980d-2a3a9e464627",
                            RegisterDate = new DateTime(2023, 10, 13, 17, 20, 17, 306, DateTimeKind.Local).AddTicks(4162),
                            SecurityStamp = new Guid("38a2bd58-0363-42ad-b05f-bd70aaf7f07a"),
                        ...
                        new
                        {
                            ...
                            IsLocked = false,
                            Mobile = "",
                            PasswordHash = "g76tBME8Lz0DQt5++GSXBw==",
                            PasswordSalt = "d7010d89-cb10-4f4e-b4b1-cbb0f874eafc",
                            RegisterDate = new DateTime(2023, 10, 13, 17, 20, 17, 307, DateTimeKind.Local).AddTicks(2059),
                            SecurityStamp = new Guid("8062bf27-e72b-42fd-97a8-38198291cf88"),
                            UserName = "siteAdmin",
                            UserType = (byte)3,
                            WrongPasswordCount = 0
                        });
            ...
            modelBuilder.Entity("Gold.Domain.Entities.BankCardNo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Gold.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<byte?>("BirthDateDay")
                        .HasColumnType("tinyint");

                    b.Property<byte?>("BirthDateMonth")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Gold.Domain.Entities.EditInformationRequest", b =>
                {
                    ...
                    b.ToTable("EditInformationRequest", "dbo");
                });
            ...
            modelBuilder.Entity("Gold.Domain.Entities.LoggingEntities.SystemActivityLog", b =>
                {
                    ...
                    b.ToTable("SystemActivityLogs", "dbo");
                });
            ...
            modelBuilder.Entity("Gold.Domain.Entities.PermissionAccess", b =>
                {
                    ...
                    b.ToTable("PermissionAccess", "dbo");
                });

            modelBuilder.Entity("Gold.Domain.Entities.ProfileImage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
