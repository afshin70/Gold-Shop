...
{
    //ckeditor with multiline
    [HtmlTargetElement("smart-editorbox", Attributes = ForAttributeName)]
    public class SmartEditorBoxTagHelper : TextAreaTagHelper
    {
        ...
        public SmartEditorBoxTagHelper(IHtmlGenerator generator) : base(generator)
        {
        }
